...
pub mod rocket_launcher {
    ...
    pub fn launcher() -> Rocket<Build> {
        ...
        let api_paths = openapi_get_routes![
            player::players,
            player::players_active,
            player::player_search,
            player::player_meta,
            player::player_moves,
            player::player_awards,
            player::player_roles,
            player::player_links,
            player::player_batch,
            player::events,
            ...
            player::turn_log,
            player::teams,
            player::team_stat_history,
            player::team_stats,
            player::team_leaderboard,
            player::team_search,
            player::team_players,
            player::team_mercs,
            player::team_odds,
            player::territories_visited,
            player::get_cases,
            player::create_case,
            player::update_case,
            player::get_case_notifications,
            player::create_case_notification,
            player::create_notification,
